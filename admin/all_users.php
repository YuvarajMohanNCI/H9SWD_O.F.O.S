...
if ($result->num_rows > 0) {
    while ($rows = $result->fetch_assoc()) {
        ...
        <tr>
            ...
            <td>
                <a href="delete_users.php?user_del=<?php echo htmlspecialchars($rows['u_id']); ?>" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
                <a href="update_users.php?user_upd=<?php echo htmlspecialchars($rows['u_id']); ?>" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
            </td>
        </tr>
<?php
    }
